...
require_once 'include\db_functions.php';
			...
			// $mail->Body = "<b>Hello You are requested to download the android app from the given link:<a href=</a> and login. The username and password are your roll numbers in uppercase.</b><br>";
			// $mail->AltBody = "";
...
{ $emailsend=[];
  ...
  //$mail[$nos]=new PHPMailer();
	...
	for($i=0;$i<$nos;$i++)
	{
		...
		if($result)
		{ $mail->Body = "<b>Hello You are requested to download the android app from the given link:<a href=</a> and login. The <br>Username : $roll_1 <br>Password : $roll_1 <br></b><br>";
